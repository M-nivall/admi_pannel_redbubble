...
//creating a query
$select = "SELECT c.county_id,c.county_name,t.town_name,t.town_name,d.address 
        FROM delivery d 
        INNER JOIN towns t on d.town = t.town_name
        RIGHT JOIN counties c ON c.county_name=d.county 
