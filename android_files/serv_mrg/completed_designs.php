...
$select = "SELECT b.order_id,b.client_id,b.business_name,b.serv_name,b.dimension,b.service_desc,b.installation_type,
     ...
     b.town_id,b.address,d.pdf_design,
          ...
          RIGHT JOIN clients c on b.client_id = c.client_id WHERE b.order_status='6' AND p.status = '2' AND d.assign_status = 'Submited' AND d.client_approval = 'Approved' ORDER BY b.order_id DESC";
