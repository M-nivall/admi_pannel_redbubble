...
$select = "SELECT b.order_id,b.client_id,b.order_cost,b.shipping_cost,b.total_cost,b.payment_code,b.county,b.town,b.address,
    b.expected_date,b.order_date,p.payment_method,p.payment_id,c.first_name,c.last_name,c.phone_no,c.email,s.ship_status
          FROM bookings b 
          INNER JOIN shipping s ON b.order_id = s.order_id
          ...
          WHERE p.status='2' AND b.order_status = '9' AND s.ship_status = 'Pending Delivery' AND s.driver_id = '$driverID' ORDER BY b.order_id DESC";
  ...
  if(mysqli_num_rows($query)>0){
      ...
      while ($row=mysqli_fetch_array($query)){
          ...
          $temp['paymentStatus'] = $row['ship_status'];
