                ...
                <div class="card-body">
                  <h4 class="card-title">Product Details </h4>
                    ...
                    $select="SELECT * FROM clients c INNER JOIN bookings b on c.client_id = b.client_id
                       ...
                       INNER JOIN order_items oi ON b.order_id = oi.order_id
                       WHERE b.order_id=".$_GET['get'];
                    ...
                    ?>
                            ...
                            <table class="table">
                                  <tbody>
                                    ...
                                    <th><b>Quantity</b> </th>
                                    <?php
                $select="SELECT * FROM bookings b INNER JOIN  order_items oi on b.order_id = oi.order_id
            RIGHT JOIN services s ON oi.product_id = s.stock_id WHERE b.order_id=".$_GET['get'];
                $query=mysqli_query($con,$select);
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Order Details </h4>
                    ...
                    INNER JOIN order_items oi ON b.order_id = oi.order_id
                       RIGHT JOIN payment p on b.order_id = p.order_id WHERE b.order_id=".$_GET['get'];
        $query=mysqli_query($con,$select);
       $row=mysqli_fetch_array($query);
                    ?>
       ...
       $row=mysqli_fetch_array($query);
                    ...
                    ?>
                            ...
                            <table class="table">
                                  ...
                                  <tbody>
                                    <tr><td><b> County</b></td><td><?php print $row2['county']?></td></tr>
                    <tr><td><b> Town</b></td><td><?php print $row2['town']?></td></tr>
